...
exports.run = async function (argv) {
    ...
    let request = new DescribeClusterAttachScriptsRequest(argv._mappingValue);


    let client = new Client(config);
    let result;
    try {
        result = await client.describeClusterAttachScriptsWithOptions(argv._[0], request, {}, runtime.getRuntimeOption(argv));
    } catch (e) {
