...
exports.cmdObj = {
  ...
  options: {
    'auto-scaling': {
      mapping: 'ModifyClusterNodePoolRequest.autoScaling',
      vtype: 'map',
      desc: {
        zh: '自动伸缩配置',
        en: ''
    ...
    'kubernetes-config': {
      mapping: 'ModifyClusterNodePoolRequest.kubernetesConfig',
      vtype: 'map',
      desc: {
        zh: '集群相关配置',
        en: ''
    ...
    'nodepool-info': {
      mapping: 'ModifyClusterNodePoolRequest.nodepoolInfo',
      vtype: 'map',
      desc: {
        zh: '节点池配置',
        en: ''
    ...
    'scaling-group': {
      mapping: 'ModifyClusterNodePoolRequest.scalingGroup',
      vtype: 'map',
      desc: {
        zh: '节点池扩容组配置',
        en: ''
    ...
    'tee-config': {
      mapping: 'ModifyClusterNodePoolRequest.teeConfig',
      vtype: 'map',
      desc: {
        en: '',
        zh: '加密计算集群配置'
    ...
    'management': {
      mapping: 'ModifyClusterNodePoolRequest.management',
      vtype: 'map',
      desc: {
        en: '',
        zh: '托管节点池配置'
    ...
    'updateNodes': {
      mapping: 'ModifyClusterNodePoolRequest.updateNodes',
      vtype: 'boolean',
      desc: {
        en: '',
        zh: '同步更新节点标签及污点'
...
exports.run = async function (ctx) {
  ...
  let ModifyClusterNodePoolRequest = require(`@alicloud/cs20151215`).ModifyClusterNodePoolRequest;
  let request = new ModifyClusterNodePoolRequest(ctx.mappingValue.ModifyClusterNodePoolRequest);
