...
exports.cmdObj={
  ...
  options: {
    'customize-config':{
      ...
      vtype: 'array',
      subType: 'map',
      mappingType: require('@alicloud/cs20151215').ModifyClusterConfigurationRequestCustomizeConfig,
      options: {
        'name':{
          mapping: 'name',
          required: false,
        ...
        'configs':{
          ...
          vtype: 'array',
          subType: 'map',
          mappingType: require('@alicloud/cs20151215').ModifyClusterConfigurationRequestCustomizeConfigConfigs,
          options: {
            'key':{
              mapping: 'key',
              required: false,
